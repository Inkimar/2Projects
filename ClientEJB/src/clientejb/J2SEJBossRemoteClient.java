...
import zanz.RemoteCalculator;

/**
 *
 * @author ingimar
 */
public class J2SEJBossRemoteClient {
    ...
    private static RemoteCalculator lookupRemoteStatelessCalculator() throws NamingException {
        ...
        final String moduleName = "CalculatorProjectEJB";
        // AS7 allows each deployment to have an (optional) distinct name. We haven't specified a distinct name for
        // our EJB deployment, so this is an empty string
        final String distinctName = "";
        // The EJB name which by default is the simple class name of the bean implementation class
        final String beanName = "CalculatorBean";// CalculatorBean.class.getSimpleName();
        // the remote view fully qualified class name
        final String viewClassName = RemoteCalculator.class.getName();
        // let's do the lookup
        String namespace = "ejb:/" + moduleName + "/"  + beanName ; //+ "!" + viewClassName;
        System.out.println("Lookup -> "+namespace);
        return (RemoteCalculator) context.lookup(namespace);
    }
